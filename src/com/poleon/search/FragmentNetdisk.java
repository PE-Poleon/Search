...
public class FragmentNetdisk extends Fragment{
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		final Button btn=(Button) getActivity().findViewById(R.id.btn_netdisk);
		final EditText edt=(EditText) getActivity().findViewById(R.id.edt_netdisk);
		
		final Intent intent=new Intent();
		intent.putExtra("something", edt.getText());
		intent.setClass(getActivity(),NetdiskActivity.class);
